...
let circleMarker01 = L.circle([19.8987,-155.6659], {
  ...
  radius: 100
              ...
              <iframe width="200" height="100" src="https://www.youtube.com/embed/J_4leOeH9Lc" title="FLYING OVER HAWAII (4K UHD) - Relaxing Music Along With Beautiful Nature Videos(4K Video Ultra HD)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
               </center>`).addTo(map);
