...
let harperMarker = L.market([35.2176665,-80.831473], {title: "CPCC Harper Campus"}).addTo(map);
let harrisMarker =L.market([35.22,-80.92], {title: "CPCC Harris Campus"}).addTo(map);
let merancasMarker =L.market([35.39,-80.84], {title: "CPCC Merancas Campus"}).addTo(map);
